...
class PatientSerializer(serializers.ModelSerializer):
    ...
    def get_todays_appointment(self, obj):
        ...
        appointment = PatientBooking.objects.filter(patient=obj, appointment_date=today, status='upcoming').first()
...
class PatientBookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'appointment_date', 'appointment_time', 'status', 'created_at', 'gender', 'age'
        ]
