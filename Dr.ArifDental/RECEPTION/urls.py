...
from .views import (
                    ...
                    MedicineListView, MedicineBillListView, MedicineBillDetailView,PatientPrescriptionAPIView
                    )
from .import views
...
urlpatterns = [
    ...
    #GET http://your-domain.com/api/patient-prescriptions/?appointment_date=2025-03-15
    #GET http://your-domain.com/api/patient-prescriptions/?patient_id=1
    #GET http://your-domain.com/api/patient-prescriptions/?booking_id=123
